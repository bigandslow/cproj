...
from cproj import Config, AgentJson, GitWorktree, EnvironmentSetup, CprojError
...
class TestEnvironmentSetup:
    ...
    def test_detect_python_files(self, temp_worktree):
        ...
        pyproject_paths, requirements_paths = env_setup._find_python_files()
        assert len(pyproject_paths) == 0
        assert len(requirements_paths) == 0
